...
import { ExtendedRoutesConfig } from '@namecheap/tsoa-cli/src/cli';
import { Tsoa, TsoaRoute, assertNever } from '@namecheap/tsoa-runtime';
import { fsReadFile, fsWriteFile, fsExists, fsMkDir } from '@namecheap/tsoa-cli/src/utils/fs';
import { AbstractRouteGenerator } from '@namecheap/tsoa-cli/src/routeGeneration/routeGenerator';
